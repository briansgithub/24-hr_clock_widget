# History: `feature/display-tab-home-lock-ux`

Append-only milestones for this branch. Current state and next actions belong in [`display-tab-home-lock-ux.md`](display-tab-home-lock-ux.md).
