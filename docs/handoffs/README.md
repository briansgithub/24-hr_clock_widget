...
|---|---|---|---|---|
| `main` | ahead of `origin/main` after timezone map merge `f0ee7c5` | Shared integration branch | [main.md](main.md) | [history](main.history.md) |
...
1. `feature/energy-entry-backup-drive` → `main` (restore stash to resume)
